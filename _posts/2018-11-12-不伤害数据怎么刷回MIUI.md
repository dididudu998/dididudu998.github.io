...
- 下载完成后，是个tgz的文件，解压它，在解压文件夹中会出现下面的文件![线刷包解压文件](/Users/ls3686/Downloads/dididudu998.github.io/images/tupian/线刷包文件列表.jpg)
...
- 下面是执行的顺序：
  ...
  - 然后重启
  - 等待完成后，就能看到久违的miui了
- ![执行步骤](/Users/ls3686/Downloads/dididudu998.github.io/images/tupian/执行步骤.jpg)
